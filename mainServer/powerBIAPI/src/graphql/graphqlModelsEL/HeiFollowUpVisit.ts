...
export const HeiFollowUpVisit = objectType({
  name: "HeiFollowUpVisit", // <- Name of your type
  definition(t) {
...
export const HeiFollowUpVisitQuery = extendType({
  type: "Query",
  definition(t) {
    t.nullable.list.nullable.field("getHeiFollowUpVisit", {
      type: "HeiFollowUpVisit",
      resolve(parent, args, context) {
        console.log("Fetching HeiFollowUpVisit ...");
        return context.prisma.heiFollowUpVisit.findMany();
      },
    });
  },
});
